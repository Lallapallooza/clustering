 ...
 *
 * Above @ref bruteForceDimFloor KDTree pruning collapses on the curse of dimensionality and a
 * blocked pairwise sweep wins; below it the tree's log-depth walks are cheaper than an N*N
 * sweep. The choice is made once at construction.
 *
...
public:
  ...
  /**
   * @brief Constructs the policy, picking the backend once against @c points.dim(1).
   *
