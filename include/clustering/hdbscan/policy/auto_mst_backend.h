...
/**
 * @brief MST backend that dispatches between Prim, Borůvka, and NN-Descent on input shape.
 *
...
public:
   ...
   *        preferred; at or above this threshold the dispatch routes to Borůvka or NN-Descent on
   *        dimension.
   *
  ...
  /**
   * @brief Dimensional ceiling above which the KDTree-based Borůvka backend gives way to the
   ...
   *
   * Returns @c 0 for Borůvka, @c 1 for Prim, and @c 2 for NN-Descent, matching the variant's
...
private:
  ...
  // Variant order is fixed: Borůvka (0), Prim (1), NN-Descent (2). @ref heldIndex leans on this.
