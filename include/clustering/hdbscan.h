 ...
 * @ref hdbscan::AutoMstBackend, which dispatches between Prim, Borůvka, and NN-Descent on the
 ...
 *                    @ref hdbscan::AutoMstBackend which picks Prim, Borůvka, or NN-Descent on
 *                    input shape.
 */
